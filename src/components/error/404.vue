  ...
  <div style="background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">版权所有<a class='link-type' href='https://wallstreetcn.com' target='_blank'>2017 © RE·CYC</a>
        </div>
...
<script>
  import img404 from 'common/image/404.png'
  import img404Cloud from 'common/image/404_cloud.png'
